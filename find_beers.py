...
classes_to_search = [
    "plastic cup of beer",  # Index 0
    "glass of beer",        # Index 1
    "pint of beer",         # Index 2
    "dark beer",            # Index 3 (Perfect for Guinness and dark Stack Cups)
    "water bottle",         # Index 4 (DISTRACTOR)
    "ketchup bottle"        # Index 5 (DISTRACTOR)
]
model.set_classes(classes_to_search)

# Define which indices are actual beers (0 to 3)
beer_indices = [0, 1, 2, 3]
